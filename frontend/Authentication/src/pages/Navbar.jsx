  ...
  return (
    <nav className="bg-gradient-to-r from-blue-300 to-pink-300 p-4 flex justify-between items-center">
      ...
      <div className="hidden lg:flex items-center space-x-4">
        ...
        <Link to="/about" className="text-white text-xl font-extrabold hover:text-blue-400">About</Link>
      ...
      {isOpen && (
        <div className="lg:hidden absolute top-full bg-gray-800 w-full left-0">
          <div className="flex flex-col space-y-2 p-4">
            ...
            <Link to="/about" className="text-white font-extrabold hover:text-blue-400">About</Link>
